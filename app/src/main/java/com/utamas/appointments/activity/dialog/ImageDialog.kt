...
class ImageDialog(private val allowGallery: Boolean, private val callback: (Options)->Unit): DialogFragment(){
    private val chooseString=resources.getString((R.string.choose_photo))
    private val takeString=resources.getString((R.string.take_photo))
    private val cancelString=resources.getString((R.string.cancel))
